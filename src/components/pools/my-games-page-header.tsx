...
import { MyGamesPageHeaderProps } from "@/lib/interfaces";
import { MY_GAMES_OUTCOME_OPTIONS, MyGamesOutcomeFilter } from "@/lib/enums";

export function MyGamesPageHeader({
  title,
  description,
  searchValue,
  onSearchChange,
  searchPlaceholder = "Search games...",
  outcomeFilter = MyGamesOutcomeFilter.ALL,
  onOutcomeFilterChange,
  rightElement,
}: MyGamesPageHeaderProps) {
  ...
  const currentLabel =
    MY_GAMES_OUTCOME_OPTIONS.find((o) => o.value === outcomeFilter)?.label ??
    "All";
        ...
        {onOutcomeFilterChange && (
          <div className="relative" ref={filterRef}>
            ...
            {filterOpen && (
              ...
              >
                {MY_GAMES_OUTCOME_OPTIONS.map((opt) => (
                  <button
                    key={opt.value}
                    type="button"
                    role="option"
