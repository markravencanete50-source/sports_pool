  ...
  return (
    <Link href={hasPool ? `/pool/${pool.id}` : "/public-pools"}>
      <Card3D intensity={15} className="w-full">
        <div className="relative overflow-hidden rounded-xl border border-primary/50 bg-gradient-to-br from-black/80 to-primary/20 backdrop-blur-xl p-4 sm:p-6 group cursor-pointer shadow-[0_0_30px_hsl(var(--primary)/0.3)] hover:shadow-[0_0_50px_hsl(var(--primary)/0.5)] transition-all duration-500">
          {/* Shine Effect */}
          ...
          <div className="relative z-20 flex flex-col items-start gap-5 min-[480px]:flex-row min-[480px]:items-center min-[480px]:justify-between">
            <div className="flex items-center gap-4 min-w-0">
              <div
                className="w-14 h-14 sm:w-16 sm:h-16 shrink-0 rounded-full bg-primary/20 flex items-center justify-center border border-primary text-2xl sm:text-3xl shadow-[0_0_15px_hsl(var(--primary)/0.8)] animate-pulse"
                aria-hidden="true"
              >
                🏆
              </div>
            ...
            <div className="flex flex-col items-start gap-1 min-[480px]:items-end shrink-0">
              <div className="text-xs text-primary font-mono uppercase tracking-widest">
                Current Pot
              </div>
              <div className="text-3xl font-black text-white font-mono tabular-nums drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">
